...
/*----------------------------------------------------*/
	...
	//Google map
	jQuery('#maps').gMap({
		address: "178 Bế Văn Đàn, Quận Thanh Khê, Thành phố Đà Nẵng, Việt Nam",
		zoom: 16,
		controls: {
         panControl: true,
         zoomControl: true,
		...
		markers: [{
			latitude: 16.065109,
			longitude: 108.196916,
			html: "<h4>Trung Linh Co., Ltd</h4><p>178 Bế Văn Đàn, Quận Thanh Khê, Thành phố Đà Nẵng, Việt Nam</p>",
			popup: true
		}]
	});
